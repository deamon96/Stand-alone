...
public class Secr_AllPrenotationsControllerPopUp implements Initializable {
    @FXML
    ...
    public void istanziaPopUp(Event e ){
        try{
            Parent root = FXMLLoader.load(getClass().getResource("/Boundary/Secr_AllPrenotationsPopUp.fxml"));
    ...
    public void initialize(URL location, ResourceBundle resource){
        ...
        ArrayList<Room> p = controller.allPrenotation();
        ...
        try {
            for (int i = 0; i < p.size(); i++){
                ...
                room.setFromp(p.get(i).getFromp());
            ...
            if (prenotationTV != null) {
                ...
                fromTC.setCellValueFactory(new PropertyValueFactory<>("fromp"));
