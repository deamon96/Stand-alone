...
public class Secr_SelfPControllerPopUp implements Initializable {
    @FXML
    ...
    public void istanziaPopUp(Event e ){
        try{
            Parent root = FXMLLoader.load(getClass().getResource("/Boundary/Secr_SelfPPopUp.fxml"));
    ...
    public void initialize(URL location, ResourceBundle resource){
        ...
        ArrayList<Room> p = controller.show_s();
